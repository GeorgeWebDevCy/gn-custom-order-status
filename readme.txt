...
3. Search for `GN Custom Order Status` and click 'Install Now' or click on the `upload` link to upload `gn-custom-order-status.zip`
4. Click on `Activate plugin`

== Changelog ==

= 1.0.0: November 24, 2023 =
* Birthday of GN Custom Order Status